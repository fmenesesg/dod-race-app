# Agent instructions — dod-race-app

## Product

**Carrera Espacial** (DevOpsDays Santiago): race game with player mobile UI and operator dashboard. Keep changes small and demo-visible.
